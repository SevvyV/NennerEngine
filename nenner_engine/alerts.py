...
# Re-export dispatch infrastructure so existing imports from .alerts keep working
from .alert_dispatch import (  # noqa: F401
    get_telegram_config, send_toast, send_telegram,
    notify_fischer_refresh, log_alert, dispatch_alert,
    is_cooled_down, TELEGRAM_SETUP_GUIDE,
)
