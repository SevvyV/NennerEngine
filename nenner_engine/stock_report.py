...
def send_email(subject: str, html_body: str,
    ...
    try:
        ...
        log.info(f"Stock report email sent to {to_addr}")
        return True
    except Exception as e:
        log.error(f"Stock report email failed: {e}")
        return False


# ---------------------------------------------------------------------------
# HTML Builders — Styles
# ---------------------------------------------------------------------------
...
_CLR_PURPLE = "#7c3aed"
_CLR_BLUE = "#3b82f6"
_CLR_LIGHT_RED = "#fef2f2"
_CLR_LIGHT_AMBER = "#fffbeb"
_CLR_LIGHT_PURPLE = "#f5f3ff"
_CLR_LIGHT_GREEN = "#f0fdf4"
_CLR_ROW_ALT = "#f8fafc"
...
<head>
  ...
  <title>Stanley's Stock Report</title>
</head>
<body style="margin:0; padding:0; background-color:{_CLR_BG}; font-family:{_FONT};">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
    <tr>
